...
'[KEVIN]
If Left$(Rdata, 7) = "PNSKILL" Then
Rdata = Right$(Rdata, Len(Rdata) - 7)
    
frmNickSkills.text1 = ReadField(1, Rdata, 44)
frmNickSkills.Text2 = ReadField(2, Rdata, 44)
frmNickSkills.Text3 = ReadField(3, Rdata, 44)
frmNickSkills.Text4 = ReadField(4, Rdata, 44)
frmNickSkills.Text5 = ReadField(5, Rdata, 44)
frmNickSkills.Text6 = ReadField(6, Rdata, 44)
frmNickSkills.Text7 = ReadField(7, Rdata, 44)
frmNickSkills.Text8 = ReadField(8, Rdata, 44)
frmNickSkills.Text9 = ReadField(9, Rdata, 44)
frmNickSkills.Text10 = ReadField(10, Rdata, 44)
frmNickSkills.Text11 = ReadField(11, Rdata, 44)
frmNickSkills.Text12 = ReadField(12, Rdata, 44)
frmNickSkills.Text13 = ReadField(13, Rdata, 44)
frmNickSkills.Text14 = ReadField(14, Rdata, 44)
frmNickSkills.Text15 = ReadField(15, Rdata, 44)
frmNickSkills.Text16 = ReadField(16, Rdata, 44)
frmNickSkills.Text17 = ReadField(17, Rdata, 44)
frmNickSkills.Text18 = ReadField(18, Rdata, 44)
frmNickSkills.Text19 = ReadField(19, Rdata, 44)
frmNickSkills.Text20 = ReadField(20, Rdata, 44)
frmNickSkills.Text21 = ReadField(21, Rdata, 44)
frmNickSkills.Text22 = ReadField(22, Rdata, 44)
frmNickSkills.Text23 = ReadField(23, Rdata, 44)
...
frmMain.tmrMacro.Enabled = False
...
'[KEVIN]
If Left$(Rdata, 3) = "CMR" Then
Rdata = Right$(Rdata, Len(Rdata) - 3)

If Not IsNumeric(Rdata) Then Exit Sub

frmMain.tmrMacro.Interval = Rdata

Exit Sub
End If
'[/KEVIN]
    
    'If logged Then Debug.Print Rdata
    ...
    Select Case sData
        ...
        '[KEVIN]**************************************************************
        '-----------------------------------------------------------------------------
        Case "FINCOFOK"          ' >>>>> Finaliza Cofre :: FINCOFOK
            frmCofres.List1(0).Clear
            frmCofres.List1(1).Clear
            NPCInvDim = 0
            Unload frmCofres
            Comerciando = False
            Exit Sub
        ...
        '[KEVIN]-----------------------------------------------
        '**************************************************************
        Case "INITCOFRE"           ' >>>>> Inicia COFRE :: INITCOFRE
            
            ii = 1
            Do While ii <= UBound(UserInventory)
                If UserInventory(ii).OBJIndex <> 0 Then
                        frmCofres.List1(1).AddItem UserInventory(ii).Name
                Else
                        frmCofres.List1(1).AddItem "Nada"
                End If
                ii = ii + 1
            Loop
            ...
            i = 1
            Do While i <= UBound(CofreInventory)
                If CofreInventory(i).OBJIndex <> 0 Then
                        frmCofres.List1(0).AddItem CofreInventory(i).Name
                Else
                        frmCofres.List1(0).AddItem "Nada"
                End If
                i = i + 1
            Loop
            Comerciando = True
        ...
        Case "SFC"
            frmCarp.Show
            Exit Sub
        Case "SFD" '<----[KEVIN](DRUIDA)
            frmDruida.Show
            Exit Sub
        Case "SFS" '<----[KEVIN](SASTRE)
            frmSastre.Show
            Exit Sub
        ...
        Case "PING"
            Ping = GetTickCount() - PingInicio
            Call AddtoRichTextBox(frmMain.RecTxt, "Ping: " & Ping, 255, 255, 255, False, False, False)
            Call SendData("PING")
            Exit Sub
    End Select
    ...
    Select Case Left(sData, 2)
        ...
        Case "CC"              ' >>>>> Crear un Personaje :: CC
            ...
            CharList(CharIndex).Fx = Val(ReadField(10, Rdata, 44))
            CharList(CharIndex).FxLoopTimes = Val(ReadField(11, Rdata, 44))
            CharList(CharIndex).Nombre = ReadField(13, Rdata, 44)
            '[Alejo-21-5]
            'CharList(CharIndex).notpasos = IIf(Val(ReadField(14, Rdata, 44)) = 1, True, False)
            'CharList(CharIndex).invisible = IIf(Val(ReadField(15, Rdata, 44)) = 1, True, False)
            
            CharList(CharIndex).iBody = ReadField(1, Rdata, 44)
            CharList(CharIndex).iHead = ReadField(2, Rdata, 44)
            CharList(CharIndex).soyNpc = (ReadField(7, Rdata, 44) = 1)
            
            Call MakeChar(CharIndex, CharList(CharIndex).iBody, CharList(CharIndex).iHead, ReadField(3, Rdata, 44), X, Y, Val(ReadField(8, Rdata, 44)), Val(ReadField(9, Rdata, 44)), Val(ReadField(12, Rdata, 44)))
            
            CharList(CharIndex).invisible = IIf((CharList(CharIndex).iHead = 0) And (CharList(CharIndex).iBody = 0), True, False)
        ...
        Case "MP"             ' >>>>> Mover un Personaje :: MP
            ...
            If Fx = 0 Then
                ...
                'If Not UserNavegando And Val(ReadField(4, Rdata, 44)) <> 0 Then
                    'If Not CharList(CharIndex).notpasos Then
        ...
        Case "CP"             ' >>>>> Cambiar Apariencia Personaje :: CP
            ...
            CharList(CharIndex).iBody = ReadField(2, Rdata, 44)
            CharList(CharIndex).Body = BodyData(Val(CharList(CharIndex).iBody))
            CharList(CharIndex).iHead = ReadField(3, Rdata, 44)
            CharList(CharIndex).Head = HeadData(Val(CharList(CharIndex).iHead))
            ...
            'CharList(CharIndex).Gm = IIf(Val(ReadField(10, Rdata, 44)) = 2, True, False)
            'CharList(CharIndex).Criminal = IIf(Val(ReadField(10, Rdata, 44)) = 1, 1, 0)
            '[Alejo-21-5]
            'CharList(CharIndex).notpasos = IIf(Val(ReadField(11, Rdata, 44)) = 1, True, False)
            'CharList(CharIndex).invisible = IIf(Val(ReadField(12, Rdata, 44)) = 1, True, False)
            CharList(CharIndex).invisible = IIf((CharList(CharIndex).iHead = 0) And (CharList(CharIndex).iBody = 0), True, False)
            If CharList(CharIndex).invisible Then
                MapData(CharList(CharIndex).POS.X, CharList(CharIndex).POS.Y).CharIndex = 0
            End If
...
#If (USAR_BINARIO = 1) Then

    'VAL
    If Left$(Rdata, 1) = Chr(2) Then     ' >>>>> Validar Cliente :: VAL
        Dim lecStr As Integer
        Rdata = Right$(Rdata, Len(Rdata) - 1)
        bK = binAsc2Dec(lecLeer(lecStr, , 4))
        ...
        Else
            lecStr = lecCambiarCadena(Rdata)
            Call Login(ValidarLoginMSG(CInt(binAsc2Dec(lecLeer(lecStr, , 4)))))
            lecCerrarCadena lecStr
        End If
        Exit Sub
    End If
...
#End If
        ...
        '[KEVIN]-------------------------------------------------------
        '**********************************************************************
        Case "SCO"                 ' >>>>> Actualiza Inventario Cofre :: SCO
            Rdata = Right$(Rdata, Len(Rdata) - 3)
            Slot = ReadField(1, Rdata, 44)
            CofreInventory(Slot).OBJIndex = ReadField(2, Rdata, 44)
            CofreInventory(Slot).Name = ReadField(3, Rdata, 44)
            CofreInventory(Slot).Amount = ReadField(4, Rdata, 44)
            CofreInventory(Slot).GrhIndex = Val(ReadField(5, Rdata, 44))
            CofreInventory(Slot).ObjType = Val(ReadField(6, Rdata, 44))
            CofreInventory(Slot).MaxHit = Val(ReadField(7, Rdata, 44))
            CofreInventory(Slot).MinHit = Val(ReadField(8, Rdata, 44))
            CofreInventory(Slot).Def = Val(ReadField(9, Rdata, 44))
        
            tempstr = ""
            
            If CofreInventory(Slot).Amount > 0 Then
                tempstr = tempstr & "(" & CofreInventory(Slot).Amount & ") " & CofreInventory(Slot).Name
            Else
                tempstr = tempstr & CofreInventory(Slot).Name
            End If
    ...
    Select Case Left(sData, 4)
        Case "NAME"
            ...
            CharList(CLng(ReadField(1, Rdata, 44))).Nombre = ReadField(2, Rdata, 44)
            
            If UserCharIndex = ReadField(1, Rdata, 44) Then Debug.Print "true"
            
            CharList(CLng(ReadField(1, Rdata, 44))).Gm = IIf(Val(ReadField(3, Rdata, 44)) = 2, True, False)
            CharList(CLng(ReadField(1, Rdata, 44))).Criminal = IIf(Val(ReadField(3, Rdata, 44)) = 1, 1, 0)
        ...
        Case "CONF"
            ...
            Rdata = Right(Rdata, Len(Rdata) - 4)
            Select Case ReadField(1, Rdata, Asc(","))
            Case 1 'modopaketes
                ConfEnv.ModoPaquetes = CLng(ReadField(2, Rdata, 44))
                Select Case CLng(ConfEnv.ModoPaquetes)
                Case 1
                    ConfEnv.IntOk = (CLng(ReadField(3, Rdata, 44)))
                    ConfEnv.IntOkCantPak = CLng(ReadField(4, Rdata, 44))
                End Select
            End Select
            Exit Sub
        Case "CEGU"
        ...
        Case "RSOS"             ' >>>>> Mensaje :: RSOS
            Rdata = Right$(Rdata, Len(Rdata) - 4)
            tempint = InStr(1, Rdata, vbTab)
            If tempint > 0 Then
                tempstr = Left(Rdata, tempint - 1)
                frmMSG.List1.AddItem tempstr
                frmMSG.MensajePoner tempstr, Right(Rdata, Len(Rdata) - tempint)
            Else
    ...
    Select Case Left(sData, 5)
        ...
        Case "NOVER"             ' >>>>> Invisible :: NOVER
            ...
            Exit Sub
        '[KEVIN]
        Case "IRSOS"             ' >>>>> Mensaje :: IRSOS
            Rdata = Right$(Rdata, Len(Rdata) - 5)
            frmTorneo.List1.AddItem Rdata
            Exit Sub
        Case "IMSOS"             ' >>>>> Mensaje :: IMSOS
            frmTorneo.Show
            Exit Sub
        '[/KEVIN]
    End Select
    ...
    Select Case Left(sData, 7)
        ...
        '[KEVIN]------------------------------------------------------------------
        '*********************************************************************************
        Case "COFREOK"           ' Banco OK :: BANCOOK
            If frmCofres.Visible Then
                i = 1
                Do While i <= UBound(UserInventory)
                    If UserInventory(i).OBJIndex <> 0 Then
                            frmCofres.List1(1).AddItem UserInventory(i).Name
                    Else
                            frmCofres.List1(1).AddItem "Nada"
                    End If
                    i = i + 1
                ...
                ii = 1
                Do While ii <= UBound(CofreInventory)
                    If CofreInventory(ii).OBJIndex <> 0 Then
                            frmCofres.List1(0).AddItem CofreInventory(ii).Name
                    Else
                            frmCofres.List1(0).AddItem "Nada"
                    End If
                    ii = ii + 1
                ...
                If ReadField(2, Rdata, 44) = "0" Then
                        frmCofres.List1(0).ListIndex = frmCofres.LastIndex1
                Else
                        frmCofres.List1(1).ListIndex = frmCofres.LastIndex2
                End If
            End If
            Exit Sub
        '[/KEVIN]************************************************************************
...
#If (USAR_BINARIO = 1) Then
lsdData = Len(sdData) + 2

'Agregamos el fin de linea
sdData = binDec2Asc(lsdData, vbInteger) & sdData & binDec2Asc(abk, vbInteger)
#Else
'Agregamos el fin de linea
...
If SendNewChar = False Then
    'OLOGIN
    SendData (Chr(3) & binDec2Asc(Len(UserName), vbInteger) & UserName & binDec2Asc(Len(UserPassword), vbInteger) & UserPassword & binDec2Asc(App.Major) & binDec2Asc(App.Minor) & binDec2Asc(App.Revision) & binDec2Asc(CLng(valcode), vbInteger) & MD5HushYo)
End If

'Crear personaje
If SendNewChar = True Then
    '[Gonzalo]: NLOGIN
    SendData (Chr(4) & binDec2Asc(Len(UserName), vbInteger) & UserName & binDec2Asc(Len(UserPassword), vbInteger) & UserPassword _
    & binDec2Asc(0, vbInteger) & binDec2Asc(0, vbInteger) _
    & binDec2Asc(App.Major) & binDec2Asc(App.Minor) & binDec2Asc(App.Revision) & _
    binDec2Asc(Len(UserRaza), vbInteger) & UserRaza & binDec2Asc(Len(UserSexo), vbInteger) & UserSexo & binDec2Asc(Len(UserClase), vbInteger) & UserClase & _
    binDec2Asc(CLng(UserAtributos(1))) & binDec2Asc(CLng(UserAtributos(2))) & binDec2Asc(CLng(UserAtributos(3))) _
    & binDec2Asc(CLng(UserAtributos(4))) & binDec2Asc(CLng(UserAtributos(5))) _
    & binDec2Asc(CLng(UserSkills(1))) & binDec2Asc(CLng(UserSkills(2))) _
    & binDec2Asc(CLng(UserSkills(3))) & binDec2Asc(CLng(UserSkills(4))) _
    & binDec2Asc(CLng(UserSkills(5))) & binDec2Asc(CLng(UserSkills(6))) _
    & binDec2Asc(CLng(UserSkills(7))) & binDec2Asc(CLng(UserSkills(8))) _
    & binDec2Asc(CLng(UserSkills(9))) & binDec2Asc(CLng(UserSkills(10))) _
    & binDec2Asc(CLng(UserSkills(11))) & binDec2Asc(CLng(UserSkills(12))) _
    & binDec2Asc(CLng(UserSkills(13))) & binDec2Asc(CLng(UserSkills(14))) _
    & binDec2Asc(CLng(UserSkills(15))) & binDec2Asc(CLng(UserSkills(16))) _
    & binDec2Asc(CLng(UserSkills(17))) & binDec2Asc(CLng(UserSkills(18))) _
    & binDec2Asc(CLng(UserSkills(19))) & binDec2Asc(CLng(UserSkills(20))) _
    & binDec2Asc(CLng(UserSkills(21))) & binDec2Asc(Len(UserEmail), vbInteger) & UserEmail _
    & binDec2Asc(Len(UserHogar), vbInteger) & UserHogar & binDec2Asc(CLng(valcode), vbInteger) & MD5HushYo)
    '[/Gonzalo]
End If
...
ElseIf EstadoLogin = CrearNuevoPj Then
    ...
    & "," & UserAtributos(4) & "," & UserAtributos(5) _
     ...
     & "," & UserEmail & "," & UserHogar & "," & valcode & MD5HushYo)
End If
