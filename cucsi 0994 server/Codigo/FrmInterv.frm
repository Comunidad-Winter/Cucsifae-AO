...
Begin VB.Form FrmInterv 
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.Frame Frame8 
         ...
         Top             =   210
         Width           =   1410
         Begin VB.TextBox txtProyectiles 
            Height          =   285
            Left            =   120
            TabIndex        =   58
            Text            =   "0"
...
IntervaloUserPuedeProyectiles = val(txtProyectiles.Text)
...
Call WriteVar(IniPath & "Server.ini", "INTERVALOS", "IntervaloLanzaProyectil", Str(IntervaloUserPuedeProyectiles))
