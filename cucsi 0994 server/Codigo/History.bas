...
'22-4-2003 - v41
'1) Bueh..gracias al excelente trabajo de Alejandro, esto
'esta estable nuevamente..kapo :D
'2) Sake los ENDC, ahora en vez de endc se lee la longitud
'del comando y se manda antes en 2 caracteres (bin)
'3) Problema.SocketWrench no trabaja bien con los datos bin
'no me pregunten porque...cambie el cli a WinSock, por lo
'tanto si tienen problemas para debuggear usando SW ya saben
'4) y en el cli toke tantas kosas ke ni me acuerdo :S nada
'grosso mas ke el tema del proto asi ke no tendrian ke haber
'problemas :P
'5) por X motivo se setea NroMacotas a 0 solo..ni idea pq,
'pero eso logra que no se destruyan los elementales..hice q
'TiempoExistencia (o algo asi..la func q mata los bichos) se
'llame siempre y ya..
'6) Apliqué parche para que se pueda equipar el barco solo
'si se esta al lado del agua :)
