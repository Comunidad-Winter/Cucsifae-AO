...
'Boludes (PARA ENVIAR UN MSG A UN USUARIO DETERMINADO DESDE EL SERVER)
Public TmpInx As Integer

Public AutenticateWord As String

Public InscAbierta As Boolean
...
'[KEVIN](PA LOS MEDITAR)
Public Const FXMEDITARCHICOVIOLETA = 16
Public Const FXMEDITARMEDIANOVERDE = 17
Public Const FXMEDITARGRANDEDORADO = 18
Public Const FXMEDITARAZUL = 19
'[/KEVIN]
...
'[KEVIN](PARA EL DRUIDA)
Public Const Raiz = 557
'[/KEVIN]
...
'[KEVIN]
Public Const OLLA_DRUIDA = 556
Public Const RED_PESCA = 543
Public Const HILAR_SASTRE = 805
Public Const TIJERAS_DRUIDA = 804
'[/KEVIN]
...
'[KEVIN]
Public Const NPCTYPE_GUARDIASCAOS = 7
Public Const NPCTYPE_QUEST = 8
Public Const NPCTYPE_AMIGOQUEST = 9
'[/KEVIN]

'[KEVIN]
Public Const NPCTYPE_ARMADAEL = 10
Public Const NPCTYPE_ARMADAELO = 11
Public Const NPCTYPE_ARMADAG = 12
Public Const NPCTYPE_ARMADAE = 13
Public Const NPCTYPE_ARMADAO = 14
'[/KEVIN]

'[KEVIN]HERRAMIENTAS NEWBIES
Public Const HACHA_LEÑADORN = 573
Public Const PIQUETE_MINERON = 575
Public Const OBJTYPE_CAÑAN = 574

Public Const OCULTAR_RAZAALTA = 903
Public Const OCULTAR_RAZABAJA = 904
'[/KEVIN]
...
'[KEVIN]
Public Const Pociones = 22
Public Const Sastreria = 23
Public Const Jardineria = 24
'[/KEVIN]
...
'[KEVIN]
'Cofre Objs
Public Const MAX_COFREINVENTORY_SLOTS = 10
'[/KEVIN]
...
Public Const OBJTYPE_ANILLO = 37
'[/KEVIN]
...
'[KEVIN]
Public Const FONTTYPE_YELLOW = "~255~255~0~0~0"
Public Const FONTTYPE_ORANGE = "~255~102~0~0~0"
Public Const FONTTYPE_CELESTE = "~104~176~204~0~1"
'[/KEVIN]
...
Public Const STAT_MAXHIT = 150
'[KEVIN]
Public Const STAT_ANILLOMAXHIT = 999
'[/KEVIN]
...
Type Inventario
    ...
    Anillo2EqpObjIndex As Integer
    Anillo2EqpSlot As Byte
    '[/KEVIN]
    NroItems As Integer
End Type
...
'[KEVIN]
Type CofreInventario
    Object(1 To MAX_COFREINVENTORY_SLOTS) As UserOBJ
    NroItems As Integer
End Type
'[/KEVIN]
...
Public Type ObjData
    ...
    '[KEVIN]
    MagiaMaxDef As Integer 'Armaduras
    MagiaMinDef As Integer 'Armaduras
    '[/KEVIN]
...
Type UserCounters
    ...
    MagiaCounter As Integer
    ProyectilesCounter As Integer
...
Type UserQuest
    Quest As Integer
    EnQuest As Byte
    RealizoQuest As Integer
    Recompensa As Integer
End Type
...
Type tQuest
    ...
    DaOro As Byte
    Oro As Long
    CriaturaIndex As Integer
    Coordenadas1 As String
    Coordenadas2 As String
    Coordenadas3 As String
    Coordenadas4 As String
    Coordenadas5 As String
    Objetivo As Integer
    NPCs As Integer
    UsUaRiOs As Integer
...
'[KEVIN]
Public NumeroQuests As Integer
'[/KEVIN]
'[KEVIN]
Public NumeroCofres As Integer
Public HaciendoBKPJS As Boolean
'[/KEVIN]
...
'[KEVIN]
Public Quests() As tQuest
'[/KEVIN]
'[KEVIN]
Public Cofres() As CofreInventario
'[/KEVIN]
...
Public Dahl As WorldPos
Public Terminus As WorldPos
Public Nexon As WorldPos
'[/KEVIN]
...
'[KEVIN]
Public InscTorneo As New cCola
'[/KEVIN]
