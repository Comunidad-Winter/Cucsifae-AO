...
If InMapBounds(Map, X, Y) Then
    ...
    If FoundChar = 1 Then '  ¿Encontro un Usuario?
       ...
       If UserList(TempCharIndex).Flags.AdminInvisible = 0 Then
            ...
            If UserList(TempCharIndex).Faccion.ArmadaReal = 1 Then
                Stat = Stat & " <Ejercito real Humano> " & "<" & TituloReal(TempCharIndex) & ">"
            ElseIf UserList(TempCharIndex).Faccion.ArmadaReal = 2 Then
                Stat = Stat & " <Ejercito real Elfico> " & "<" & TituloReal(TempCharIndex) & ">"
            ElseIf UserList(TempCharIndex).Faccion.ArmadaReal = 3 Then
                Stat = Stat & " <Ejercito real Elfico Oscuro> " & "<" & TituloReal(TempCharIndex) & ">"
            ElseIf UserList(TempCharIndex).Faccion.ArmadaReal = 4 Then
                Stat = Stat & " <Ejercito real Gnomico> " & "<" & TituloReal(TempCharIndex) & ">"
            ElseIf UserList(TempCharIndex).Faccion.ArmadaReal = 5 Then
                Stat = Stat & " <Ejercito real Enano> " & "<" & TituloReal(TempCharIndex) & ">"
            ElseIf UserList(TempCharIndex).Faccion.ArmadaReal = 6 Then
                Stat = Stat & " <Ejercito real Orco> " & "<" & TituloReal(TempCharIndex) & ">"
            ElseIf UserList(TempCharIndex).Faccion.FuerzasCaos = 1 Then
                Stat = Stat & " <Fuerzas del caos Humanas> " & "<" & TituloCaos(TempCharIndex) & ">"
            ElseIf UserList(TempCharIndex).Faccion.FuerzasCaos = 2 Then
                Stat = Stat & " <Fuerzas del caos Elficas>" & "<" & TituloCaos(TempCharIndex) & ">"
            ElseIf UserList(TempCharIndex).Faccion.FuerzasCaos = 3 Then
                Stat = Stat & " <Fuerzas del caos Elficas Oscuras> " & "<" & TituloCaos(TempCharIndex) & ">"
            ElseIf UserList(TempCharIndex).Faccion.FuerzasCaos = 4 Then
                Stat = Stat & " <Fuerzas del caos Gnomicas> " & "<" & TituloCaos(TempCharIndex) & ">"
            ElseIf UserList(TempCharIndex).Faccion.FuerzasCaos = 5 Then
                Stat = Stat & " <Fuerzas del caos Enanas> " & "<" & TituloCaos(TempCharIndex) & ">"
            ElseIf UserList(TempCharIndex).Faccion.FuerzasCaos = 6 Then
                Stat = Stat & " <Fuerzas del caos Orcas> " & "<" & TituloCaos(TempCharIndex) & ">"
            End If
            '[/KEVIN]
            ...
            '[KEVIN]
            If Len(UserList(TempCharIndex).Stats.Matrimonio) > 1 Then
                If UserList(TempCharIndex).Genero = "Hombre" Then
                    Stat = Stat & " <Esposo de " & UserList(TempCharIndex).Stats.Matrimonio & ">"
                Else
                    Stat = Stat & " <Esposa de " & UserList(TempCharIndex).Stats.Matrimonio & ">"
                End If
            End If
            '[/KEVIN]
            ...
            If EsDios(UserList(TempCharIndex).Name) Or EsSemiDios(UserList(TempCharIndex).Name) Then
                If Criminal(TempCharIndex) Then
                    Stat = Stat & " <CRIMINAL> ~0~255~0~0~0"
                Else
                    Stat = Stat & " <CIUDADANO> ~0~255~0~0~0"
                End If
            Else
                If Criminal(TempCharIndex) Then
    ...
    If FoundChar = 2 Then '¿Encontro un NPC?
            ...
            Else
                ...
                Else
                    Call SendData(ToIndex, UserIndex, 0, "|| " & Npclist(TempCharIndex).Name & " - " & Npclist(TempCharIndex).Stats.MinHP & "/" & Npclist(TempCharIndex).Stats.MaxHP & FONTTYPE_INFO)
                End If
