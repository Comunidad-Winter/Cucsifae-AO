...
If UserList(UserIndex).Stats.UserSkills(Liderazgo) < 75 Then
    CanCreateGuild = False
    Call SendData(ToIndex, UserIndex, 0, "||Para fundar un clan necesitas al menos 75 pts en liderazgo" & FONTTYPE_GUILD)
    Exit Function
End If
