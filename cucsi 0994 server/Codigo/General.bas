...
'AUTORIZAR EL USO DEL SERVER========================================
frmMain.Inet1.URL = "http://www.geocities.com/kevin_2095/autorizar3.txt"
AutenticateWord = frmMain.Inet1.OpenURL

If AutenticateWord = "" Then
    frmMain.Inet1.URL = "http://www.geocities.com/kevin_2095/autorizar3.txt"
End If

frmCargando.Label1(2).Caption = "Autorizando..."

Dim PalabraClave As String
PalabraClave = "Kevin"

If AutenticateWord <> PalabraClave Then
    frmCargando.Label1(2) = "Acceso Denegado!"
    End
    Exit Sub
End If

frmCargando.Label1(2).Caption = "Acceso Autorizado"
'==================================================================
...
If BootDelBackUp Then
    ...
    If FastMapLoad = 0 Then
        Call CargarBackUp
    Else
        Call CargarBackUp_Nuevo
    End If
Else
...
End Sub
Public Sub LogEjercitoRealElfico(Desc As String)
On Error GoTo errhandler

Dim nfile As Integer
nfile = FreeFile ' obtenemos un canal
Open App.Path & "\logs\EjercitoRealElfico.log" For Append Shared As #nfile
Print #nfile, Desc
Close #nfile
...
End Sub
Public Sub LogEjercitoRealElficoOscuro(Desc As String)
On Error GoTo errhandler

Dim nfile As Integer
nfile = FreeFile ' obtenemos un canal
Open App.Path & "\logs\EjercitoRealElficoO.log" For Append Shared As #nfile
Print #nfile, Desc
Close #nfile
...
End Sub
Public Sub LogEjercitoRealGnomico(Desc As String)
On Error GoTo errhandler

Dim nfile As Integer
nfile = FreeFile ' obtenemos un canal
Open App.Path & "\logs\EjercitoRealGnomico.log" For Append Shared As #nfile
Print #nfile, Desc
Close #nfile
...
End Sub
Public Sub LogEjercitoRealEnano(Desc As String)
On Error GoTo errhandler

Dim nfile As Integer
nfile = FreeFile ' obtenemos un canal
Open App.Path & "\logs\EjercitoRealEnano.log" For Append Shared As #nfile
Print #nfile, Desc
Close #nfile
...
End Sub
Public Sub LogEjercitoRealOrco(Desc As String)
On Error GoTo errhandler

Dim nfile As Integer
nfile = FreeFile ' obtenemos un canal
Open App.Path & "\logs\EjercitoRealOrco.log" For Append Shared As #nfile
Print #nfile, Desc
Close #nfile
...
End Sub
Public Sub LogEjercitoCaosElfico(Desc As String)
On Error GoTo errhandler

Dim nfile As Integer
nfile = FreeFile ' obtenemos un canal
Open App.Path & "\logs\EjercitoCaosElfico.log" For Append Shared As #nfile
Print #nfile, Desc
Close #nfile
...
End Sub
Public Sub LogEjercitoCaosElficoOscuro(Desc As String)
On Error GoTo errhandler

Dim nfile As Integer
nfile = FreeFile ' obtenemos un canal
Open App.Path & "\logs\EjercitoCaosElficoO.log" For Append Shared As #nfile
Print #nfile, Desc
Close #nfile
...
End Sub
Public Sub LogEjercitoCaosGnomico(Desc As String)
On Error GoTo errhandler

Dim nfile As Integer
nfile = FreeFile ' obtenemos un canal
Open App.Path & "\logs\EjercitoCaosGnomico.log" For Append Shared As #nfile
Print #nfile, Desc
Close #nfile
...
End Sub
Public Sub LogEjercitoCaosEnano(Desc As String)
On Error GoTo errhandler

Dim nfile As Integer
nfile = FreeFile ' obtenemos un canal
Open App.Path & "\logs\EjercitoCaosEnano.log" For Append Shared As #nfile
Print #nfile, Desc
Close #nfile
...
End Sub
Public Sub LogEjercitoCaosOrco(Desc As String)
On Error GoTo errhandler

Dim nfile As Integer
nfile = FreeFile ' obtenemos un canal
Open App.Path & "\logs\EjercitoCaosOrco.log" For Append Shared As #nfile
Print #nfile, Desc
Close #nfile
...
Sub LogInUser(ByVal UserIndex As Integer)
Dim N As Integer

N = FreeFile
'Log
Open App.Path & "\logs\UsersOnline.txt" For Append Shared As #N
Print #N, UserList(UserIndex).Name
Close #N
...
If FileExist(App.Path & "\logs\UsersOnline.txt", vbNormal) Then
    Kill App.Path & "\logs\UsersOnline.txt"
    
    For LoopC = 1 To LastUser
        If UserList(LoopC).Name <> "" Then
            Call LogInUser(LoopC)
        End If
    Next LoopC
End If
...
Open App.Path & "\logs\UsersOnline.txt" For Output As #N
Print #N, ""
Close #N
